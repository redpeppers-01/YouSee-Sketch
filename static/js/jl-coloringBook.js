...
customElements.define('jl-coloringbook', class extends HTMLElement 
{
    constructor() 
    {
        ...
        this.loadIcons();
        this.isSharing = false; // Add sharing flag
    }
    ...
    drawTemplate()
    {
            ...
            <div class="wrapper">
                ...
                <div class="toolbar">
                    <div class="tools">
                        ...
                        <button class="shareButton  button"><i class="material-icons"></i></button>
                    </div>
        ...
        jQuery(`.shareButton`,this.shadowRoot).on('click', function() {me.share()});
    ...
    async save()
    {
        try {
            ...
            $(document).trigger('showNotification', ['An error occurred while saving the image']);
        }
    }
